      ...
      <div className="w-80 h-[90%] bg-white bg-opacity-20 rounded-[2rem] shadow-lg p-6 border border-1">
        ...
        <div className="w-full h-full bg-white rounded-3xl p-4 flex flex-col">
          ...
          <div className="flex flex-col space-y-4 flex-grow">
            <button className="flex items-center space-x-2 p-2 rounded-md bg-gray-100 hover:bg-gray-300 border-2 border-transparent hover:border-transparent">
          ...
          <div className="mt-4 flex items-center justify-center">
            <button className="flex w-full items-center space-x-2 p-2 rounded-md bg-gray-100 hover:bg-gray-300 border-2 border-transparent hover:border-transparent">
